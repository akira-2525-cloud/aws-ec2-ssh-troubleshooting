...
📸 Screenshot:  
![Connection failed](images/connection-failed2.png)  
...
📸 Screenshots:  
![Security Group wrong](images/sg-wrong2.png)  
![Route Table before](images/route-table-before2.png)  
...
📸 Screenshots:  
![Security Group fixed](images/sg-fixed2.png)  
![Route Table fixed](images/route-table-fixed2.png?v=1)  
...
📸 Screenshots:  
![SSH login success](images/ssh-success2.png)  
...
├── README.md  
└── images/  
    ├── connection-failed2.png  
    ├── route-table-before2.png  
    ├── route-table-fixed2.png  
    ├── sg-fixed2.png  
    ├── sg-wrong2.png  
    └── ssh-success2.png  
